      ...
      <div className="flex flex-col gap-10">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <FormItem name="fullName" rules={[{ required: true, message: "অনুগ্রহ করে আপনার পূর্ণ নাম লিখুন" }]}>
                <input
                  type="text"
                  id="fullName"
            ...
            {/* Photo Upload */}
            <div>
              <label htmlFor="nid" className="mb-2 block text-sm font-bold text-gray-700">
                পাসপোর্ট সাইজ ছবি আপলোড করুন
              </label>
              <FormItem name="image" rules={[{ required: true, message: "অনুগ্রহ করে আপনার ছবি আপলোড করুন" }]} valuePropName="file" className="mb-0">
                <Upload listType="picture-card" maxCount={1} beforeUpload={() => false} accept="image/*" className="kaji-photo-upload">
                  <div className="flex flex-col items-center justify-center p-4">
                    <div className="size-5 bg-primary/5 rounded-2xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <FormItem name="licenseNumber" rules={[{ required: true, message: "অনুগ্রহ করে আপনার লাইসেন্স নম্বর লিখুন" }]}>
                <input
                  type="text"
                  id="licenseNumber"
            ...
            <div>
              ...
              <FormItem name="organizationName" rules={[{ required: true, message: "অনুগ্রহ করে আপনার প্রতিষ্ঠানের নাম লিখুন" }]}>
                <input
                  type="text"
                  id="organizationName"
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Division */}
            <div>
              <label className="mb-2 text-sm font-bold text-gray-700 block">বিভাগ</label>
              <FormItem name="division" rules={[{ required: true, message: "বিভাগ নির্বাচন করুন" }]}>
                <Select placeholder="বিভাগ Choose" size="large" className="w-full custom-select" onChange={handleDivisionChange} loading={fetchingDivisions}>
                  {divisions.map((div) => (
            ...
            {/* District */}
            <div>
              <label className="mb-2 text-sm font-bold text-gray-700 block">জেলা</label>
              <FormItem name="district" rules={[{ required: true, message: "জেলা নির্বাচন করুন" }]}>
                <Select placeholder="জেলা Choose" size="large" className="w-full custom-select" onChange={handleDistrictChange} loading={fetchingDistricts} disabled={!districts.length}>
                  {districts.map((dist) => (
            ...
            {/* Upazila */}
            <div>
              <label className="mb-2 text-sm font-bold text-gray-700 block">উপজেলা</label>
              <FormItem name="upazila" rules={[{ required: true, message: "উপজেলা নির্বাচন করুন" }]}>
                <Select placeholder="উপজেলা Choose" size="large" className="w-full custom-select" loading={fetchingUpazillas} disabled={!upazillas.length}>
                  {upazillas.map((up) => (
            ...
            <div className="md:col-span-3">
              ...
              <FormItem name="addressLine" rules={[{ required: true, message: "অনুগ্রহ করে আপনার বিস্তারিত ঠিকানা লিখুন" }]}>
                <input
                  type="text"
                  id="addressLine"
        ...
        <div className="pt-6">
          ...
          >
            {loading ? <AiOutlineLoading3Quarters className="animate-spin" fontSize={20} /> : <>নিবন্ধন সম্পন্ন করুন</>}
          </button>
          <p className="mt-4 text-xs text-gray-400 italic">* সকল তথ্য নির্ভুলভাবে প্রদান করা বাধ্যতামূলক। ভুল তথ্যের জন্য আবেদন বাতিল হতে পারে।</p>
        </div>
      </div>
    </Form>
  );
